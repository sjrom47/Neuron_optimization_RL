"""Gymnasium environment for optimizing stimulation waveforms in NEURON."""
...
from simulation.utils import firing_rate
from simulation.waveforms import (
...
class NEURONEnv(Env):
    """Vectorizable RL environment backed by Ray-hosted NEURON simulations."""
    ...
    def plot_waveform_and_response(
        ...
        plt.tight_layout()
        plt.savefig(plot_dir / f"{plot_name}.png")
        plt.close()
