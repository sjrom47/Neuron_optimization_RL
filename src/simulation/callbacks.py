...
from simulation.paths import PLOTS_DIR


class TrainingProgressCallback(BaseCallback):
    """Records per-episode returns across vectorized envs and saves a progress plot."""

    def __init__(self, run_dir=PLOTS_DIR, plot_freq=10, step_plot_freq=100):
        super().__init__()
...
class WaveformSnapshotCallback(BaseCallback):
    ...
    def __init__(self, run_dir=PLOTS_DIR, snap_freq=20, n_waveforms=8):
        super().__init__()
        self.run_dir = run_dir
...
class EpisodeStepRewardCallback(BaseCallback):
    ...
    def __init__(self, max_steps=10, run_dir=PLOTS_DIR, plot_freq=50, window=200):
        super().__init__()
