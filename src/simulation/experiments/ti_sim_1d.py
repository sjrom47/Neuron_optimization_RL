...
from simulation.experiments.helper import cart_to_sph, sph_to_cart, sample_1d
...
SAVE_PATH = os.path.join(str(TI_RESULTS_DIR), 'TI/1-D')
#SAVE_PATH = "Garbage"
...
for l in range(sim_already_performed,len(amp_level)):
    ...
    if int(amp_level[l])==1100:
        ...
        plt.savefig(os.path.join(str(TI_RESULTS_DIR), 'Figs5Main/Fig5-l.png'))
