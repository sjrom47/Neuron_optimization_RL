...
h.load_file(str(CELLS_DIR / "L23_LBC_cNAC187_1" / "template.hoc"))  # Update with the actual path to the .hoc file
h.load_file(str(CELLS_DIR / "L23_LBC_cNAC187_2" / "template.hoc"))       # Update with the actual path to the .hoc file
